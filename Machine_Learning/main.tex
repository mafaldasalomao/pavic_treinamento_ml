...
\begin{frame}
	...
	\begin{block}{Dimensão das matrizes}
		\begin{columns}
			...
			\textit{B} = $1x4$ Cada neurônio possui um bias.
			\end{column}
		\end{columns}
	...
	\begin{block}{Dimensão das matrizes}
		\begin{columns}
			...
			\begin{column}{0.6\textwidth}
				...
				W = $4x4$ \\
				Y = $1x4$ \\
				A multiplicação das matrizes $1X4 * 4x4$ nos retornará uma matriz $1x4$, que deve ser a mesma dimensão do \textit{bias}. \\
				\textit{B} = $1x4$ Cada neurônio possui um bias.
			\end{column}
		\end{columns}
	...
	\begin{block}{Dimensão das matrizes}
		\begin{columns}
			...
			\begin{column}{0.6\textwidth}
				...
				\textit{B} = $1x1$ Cada neurônio possui um bias.
			\end{column}
		\end{columns}
...
\begin{frame}
	...
	\begin{block}{Sigmoid Cross Entropy}
